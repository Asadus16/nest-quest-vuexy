...
const PersonalDetailsTab = ({ invitation }: { invitation: TenantInvitationType }) => {
          ...
          <CardContent>
            <Grid container spacing={4}>
              <Grid size={{ xs: 12, sm: 6 }}>
                <DetailRow icon='tabler-user' label='Full Name' value={tenant?.full_name} />
              </Grid>
              <Grid size={{ xs: 12, sm: 6 }}>
              ...
              <Grid size={{ xs: 12, sm: 6 }}>
                <DetailRow
                  ...
                  label='Date of Birth'
                  value={tenant?.dob ? new Date(tenant.dob).toLocaleDateString() : null}
                />
              </Grid>
              <Grid size={{ xs: 12, sm: 6 }}>
                <DetailRow icon='tabler-flag' label='Nationality' value={tenant?.nationality} />
              </Grid>
              <Grid size={{ xs: 12, sm: 6 }}>
