          ...
          <CardContent>
            <Grid container spacing={4}>
              <Grid size={{ xs: 12, sm: 6 }}>
                <DetailRow icon='tabler-user' label='Full Name' value={owner?.full_name} />
              </Grid>
              <Grid size={{ xs: 12, sm: 6 }}>
              ...
              <Grid size={{ xs: 12, sm: 6 }}>
                <DetailRow
                  ...
                  label='Date of Birth'
                  value={owner?.dob ? new Date(owner.dob).toLocaleDateString() : null}
                />
              </Grid>
              <Grid size={{ xs: 12, sm: 6 }}>
                <DetailRow icon='tabler-flag' label='Nationality' value={owner?.nationality} />
              </Grid>
            </Grid>
          </CardContent>
        </Card>
