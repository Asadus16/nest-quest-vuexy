    ...
    <Grid container spacing={6}>
      ...
      <Grid size={{ xs: 12, sm: 6 }}>
        <DocumentCard
          ...
          title='Emirates ID'
          fields={[
            { label: 'ID Number', value: owner?.emirates_id_number },
            {
              label: 'Expiry Date',
              value: owner?.emirates_id_expiry ? new Date(owner.emirates_id_expiry).toLocaleDateString() : null
            }
          ]}
        />
      </Grid>
      ...
      <Grid size={{ xs: 12, sm: 6 }}>
        <DocumentCard
          ...
          title='Passport'
          fields={[
            { label: 'Passport Number', value: owner?.passport_number },
            {
              label: 'Expiry Date',
              value: owner?.passport_expiry ? new Date(owner.passport_expiry).toLocaleDateString() : null
            },
            { label: 'Issued Country', value: owner?.passport_issued_country }
          ]}
        />
      </Grid>
