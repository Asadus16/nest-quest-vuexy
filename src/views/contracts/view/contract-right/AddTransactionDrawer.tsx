...
// Service Imports
import { createTransaction } from '@/services/financial'
...
const AddTransactionDrawer = ({ open, handleClose, contract, defaultType, onSuccess }: AddTransactionDrawerProps) => {
  ...
  const handleSubmit = async () => {
    if (!category || !amount || !transactionDate) return
    ...
    >
      ...
      <div className='flex flex-col gap-5 p-6'>
        ...
        <Button
          ...
          disabled={submitting || !category || !amount || !transactionDate}
